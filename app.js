...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        int = numSplit[0];
        if (int.length > 3) {
            // if input 2310 then output is 2,310 or 23510 = 23,510
    ...
    var nodeLsitForEach = function(list, callback) {
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            if (type === 'inc') {
                element = DOMStrings.incomeConainer;
            ...
            // Replace Placeholder text with the data
        ...
        displayPercentages: function(percentages) {
            ...
            nodeLsitForEach(fields, function(current, index) {
        ...
        changeType: function() {
            ...
            nodeLsitForEach(fields, function(cur) {
...
var AppController = (function(budgetCtrlr, UICtrlr) {
    ...
    var updatePercentages = function() {
        ...
        // Read input from Budget Controller
